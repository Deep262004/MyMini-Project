...
const Contact = () => {
            ...
            const contactUs = useFormik({
              ...
              onSubmit: (values, { resetForm, setSubmitting }) => {
                ...
                axios.post('http://localhost:5000/enquiry/add', values)
                  .then((result) => {
                    toast.success('Send Enquiry');
                    resetForm();
                  }).catch((err) => {
                    console.log(err);
          ...
          <form onSubmit={contactUs.handleSubmit}>
            <div className="grid gap-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                {
                    (contactUs.errors.name && signupForm.touched.firstname) && (
                      <p className="text-xs text-red-600 mt-2" id="email-error">
                        {contactUs.errors.firstname}
                      </p>
                    )
                  }
                <div>
              ...
              {
                    (contactUs.errors.name && signupForm.touched.lastname) && (
                      <p className="text-xs text-red-600 mt-2" id="email-error">
                        {contactUs.errors.lastname}
                      </p>
                    )
                  }
              {/* End Grid */}
              ...
              {
                    (contactUs.errors.name && signupForm.touched.email) && (
                      <p className="text-xs text-red-600 mt-2" id="email-error">
                        {contactUs.errors.email}
                      </p>
                    )
                  }
              <div>
              ...
              {
                    (contactUs.errors.name && signupForm.touched.phoneNumber) && (
                      <p className="text-xs text-red-600 mt-2" id="email-error">
                        {contactUs.errors.phoneNumber}
                      </p>
                    )
                  }
              <div>
            ...
            {
                    (contactUs.errors.name && signupForm.touched.about) && (
                      <p className="text-xs text-red-600 mt-2" id="email-error">
                        {contactUs.errors.about}
                      </p>
                    )
                  }
            {/* End Grid */}
            <div className="mt-4 grid">
              ...
              >
              {contactUs.isSubmitting ? <IconLoader3 className='animate-spin' /> : <IconCheck />}
                  {contactUs.isSubmitting ? 'Submitting...' : ' Send Enquiry'}
              </button>
